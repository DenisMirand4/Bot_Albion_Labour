    ...
    while(True):
        if locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\logout.png', confidence = 0.8) != None:
            ...
            if pyautogui.locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\Viajador.png', confidence = 0.5) or pyautogui.locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\Topo_viajador.png', confidence = 0.5) or pyautogui.locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\Topo_viajador_noite.png', confidence = 0.5) != None :
                ...
                time.sleep(3)
                if pyautogui.locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\Ilha_fort.png', confidence = 0.7)  != None :
                    time.sleep(0.2)
...
def inv_bau():
    '''CLICK NO INVENTARIO *2
    x	  1	      2	      3	      4		    y	 1 	 2	 3	 4
    1	1590	1672	1748	1830		1	550	550	550	550
    2	1590	1672	1748	1830		2	632	632	632	632
    3	1590	1672	1748	1830		3	711	711	711	711
    4	1590	1672	1748	1830		4	789	789	789	789
    5	1590	1672	1748	1830		5	873	873	873	873
    6	1590	1672	1748	1830		6	930	930	930	930

    CLICK NO BAU
    x	1	2	3	4	5			y	1	2	3	4	5
    1	93	175	252	337	413			1	373	373	373	373	373
    2	93	175	252	337	413			2	452	452	452	452	452
    3	93	175	252	337	413			3	531	531	531	531	531
    4	93	175	252	337	413			4	612	612	612	612	612
    5   93  175 252 337 413         5   675 675 675 675 675
        '''
    time.sleep(0.2)
...
def guardar_itens():
    ...
    while(True):
        if pyautogui.locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\inventario.png', confidence = 0.8) != None:
            ...
            time.sleep(0.5)
            break
        if pyautogui.locateOnScreen('C:\\Users\\denis\\Desktop\\Bot albion\\Imagens\\banco.png') != None:
            pyautogui.press('esc')
            time.sleep(1)
...
pegou = True
for x,y in numero_ilha.items():# here is where the magic happens 
    if(y):
        viaja_prox(x)
        time.sleep(3)
    if(y==False):
    ...
    time.sleep(1)
    error_volta = volta_trabalhador()
    time.sleep(1)

    if (x == 20):
        viaja_prox(-1)
        guardar_itens()
        pegou = pegar_diario(x)
    if (x == 40):
        viaja_prox(-1)
        guardar_itens()
        pegar_diario(x)
